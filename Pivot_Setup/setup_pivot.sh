...
echo "[1/9] Customizing Wandisco repository and enabling epel repo "
...
echo "[2/9] Installing basic packages (git, ansible, python, etc.)"
...
echo "[5/9] Initializing AWS credentials"
...
echo "[6/9] Create hosting directories"
